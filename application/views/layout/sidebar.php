...
<aside id="sidebar">
    ...
    <ul class="sidebar-nav">
        <li>
            <a href="<?= site_url('dashboard'); ?>" class="nav-link <?= ($seg1 == 'dashboard' || $seg1 == '') ? 'active' : ''; ?>">
    ...
    <ul class="sidebar-nav">
        <li>
            <a href="<?= site_url('pembelian/create'); ?>" class="nav-link <?= ($seg1 == 'pembelian' && $this->uri->segment(2) == 'create') ? 'active' : ''; ?>">
                <i class="bi bi-truck"></i> Pembelian Stok
            </a>
        </li>
        <li>
            <a href="<?= site_url('pembelian'); ?>" class="nav-link <?= ($seg1 == 'pembelian' && $this->uri->segment(2) != 'create') ? 'active' : ''; ?>">
                <i class="bi bi-clipboard-data"></i> Daftar Pembelian
            </a>
        </li>
        <li>
            <a href="<?= site_url('riwayat-stok'); ?>" class="nav-link <?= ($seg1 == 'riwayat-stok' || $seg1 == 'riwayat_stok') ? 'active' : ''; ?>">
    ...
    <nav class="navbar navbar-expand-lg top-navbar">
        <div class="container-fluid px-0">
            ...
            <div class="ms-auto d-flex align-items-center">
                <div class="dropdown">
                    <a class="nav-link dropdown-toggle d-flex align-items-center py-1 px-3 bg-light rounded-pill" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <span class="badge <?= ($role === 'owner') ? 'bg-warning text-dark' : 'bg-info text-dark'; ?> ms-1 text-uppercase" style="font-size: 0.65rem;">
                            <?= html_escape($role); ?>
                        </span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end shadow border-0 mt-2">
                        <li><h6 class="dropdown-header">Account Role: <?= ucfirst($role); ?></h6></li>
